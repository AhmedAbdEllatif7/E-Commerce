<x-guest-layout>
    ...
    <style>
        ...
        .login-card {
            ...
            width: 300px;
            position: relative; /* To position labels inside the container */
        }
        ...
        .label {
            position: absolute;
            right: 100px; /* Adjust this value for proper positioning */
            top: 39%;
                ...
                <div class="login-card">
                    <div class="img-container">
                        <a class="btn btn-default" title="Customer" href="{{ route('login.show', 'customer') }}">
                            <img class="user-img" size="100%" alt="user-img" src="{{ URL::asset('assets/images/1077114.png') }}" style="width: 60px; height: 60px">
                        </a>
                    </div>
