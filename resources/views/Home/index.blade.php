                        ...
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                <a href="product-detail.html">
                                    <img src="{{ URL::asset('attachments/upload_attachments/' . $randomProduct->image) }}" alt="Slider Image" style="width: 100%; height: 300px;" />
                                </a>
                ...
                <div class="row align-items-center product-slider product-slider-4">
                    ...
                    <div class="col-lg-3">
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                <a href="product-detail.html">
                                    <img src="{{ URL::asset('attachments/upload_attachments/' . $recentProduct->image) }}" alt="Slider Image" style="width: 100%; height: 300px;" />
                                </a>
                                <div class="product-action">
