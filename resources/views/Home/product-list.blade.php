                                                        ...
                                                        <div class="product-item">
                                                            ...
                                                            <div class="product-image">
                                                                <a href="product-detail.html">
                                                                    <img src="{{URL::asset('attachments/upload_attachments/'.$product->image)}}" alt="Slider Image"  style="width: 100%; height: 300px;"/>
                                                                </a>
                                                                <div class="product-action">
                                                ...
                                                <div class="sidebar-slider normal-slider">
                                                    @foreach ($products as $product )
                                                        <div class="product-item">
                                                            ...
                                                            <div class="product-image">
                                                                <a href="{{ route('product.show',$product->id) }}">
                                                                    <img src="{{ URL::asset('attachments/upload_attachments/'.$product->image) }}" alt="Product Image" style="width: 100%; height: 400px;" >
                                                                </a>
                                                                <div class="product-action">
                                                                    <a href="{{ route('customer.product.show',$product->id) }}"><i class="fa fa-cart-plus"></i></a>
                                                                    @if(auth()->guard('customer')->user())
