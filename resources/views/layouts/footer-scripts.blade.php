...
<script>
    $(document).ready(function() {
        // Initialize Toastr.js options
        toastr.options = {
            positionClass: 'toast-top-right', // Adjust the position as needed
            timeOut: 3000, // Adjust the display duration (milliseconds)
        };
        ...
        $('.wishlist').on('click', function(event) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    toastr.success('Added to wishlist', 'Success'); // Display a success message
                },
                error: function(xhr, status, error) {
                    toastr.error('The product already added', 'Warning'); // Display an error message
